...
"x86_64-linux-3.13.0-66-generic" or
	die "Errno architecture (x86_64-linux-3.13.0-66-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
